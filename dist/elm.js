...
*/
  ...
  var $author$project$Donut$Chart$init = _Utils_Tuple2(
    $author$project$Donut$Chart$initialModel,
    $elm$core$Platform$Cmd$none,
  );
  var $author$project$Demo$initialModel = {
    chart: $author$project$Donut$Chart$init.a,
    count: 0,
  };
  ...
  var $author$project$Donut$Chart$update = F2(function (msg, model) {
    if (msg.$ === "SegmentHovered") {
      ...
      return _Utils_Tuple2(
        _Utils_update(model, { hoveredSegment: $elm$core$Maybe$Nothing }),
        $elm$core$Platform$Cmd$none,
      );
    }
  });
  var $author$project$Demo$update = F2(function (msg, model) {
    var msg_ = msg.a;
    var _v1 = A2($author$project$Donut$Chart$update, msg_, model.chart);
    var m = _v1.a;
    var cmd = _v1.b;
    return _Utils_Tuple2(
      _Utils_update(model, { chart: m }),
  ...
  var $author$project$Donut$Util$fromTWcolorToHex = function (twCol) {
    return A2(
      ...
      A2(
        ...
        function (color) {
          return color === "bg-red-50"
            ? $elm$core$Maybe$Just("#fef2f2")
            : color === "bg-red-100"
              ? $elm$core$Maybe$Just("#fee2e2")
              : color === "bg-red-200"
                ? $elm$core$Maybe$Just("#fecaca")
                : color === "bg-red-300"
                  ? $elm$core$Maybe$Just("#fca5a5")
                  : color === "bg-red-400"
                    ? $elm$core$Maybe$Just("#f87171")
                    : color === "bg-red-500"
                      ? $elm$core$Maybe$Just("#ef4444")
                      : color === "bg-red-600"
                        ? $elm$core$Maybe$Just("#dc2626")
                        : color === "bg-red-700"
                          ? $elm$core$Maybe$Just("#b91c1c")
                          : color === "bg-red-800"
                            ? $elm$core$Maybe$Just("#991b1b")
                            : color === "bg-red-900"
                              ? $elm$core$Maybe$Just("#7f1d1d")
                              : color === "bg-red-950"
                                ? $elm$core$Maybe$Just("#450a0a")
                                : color === "bg-orange-50"
                                  ? $elm$core$Maybe$Just("#fff7ed")
                                  : color === "bg-orange-100"
                                    ? $elm$core$Maybe$Just("#ffedd5")
                                    : color === "bg-orange-200"
                                      ? $elm$core$Maybe$Just("#fed7aa")
                                      : color === "bg-orange-300"
                                        ? $elm$core$Maybe$Just("#fdba74")
                                        : color === "bg-orange-400"
                                          ? $elm$core$Maybe$Just("#fb923c")
                                          : color === "bg-orange-500"
                                            ? $elm$core$Maybe$Just("#f97316")
                                            : color === "bg-orange-600"
                                              ? $elm$core$Maybe$Just("#ea580c")
                                              : color === "bg-orange-700"
                                                ? $elm$core$Maybe$Just(
                                                    "#c2410c",
                                                  )
  ...
  var $author$project$Donut$Util$fromComplexToChartData = function (
    dataPointLst,
  ) {
  ...
  var $author$project$Donut$Util$slice = F3(function (start, end, lst) {
    return A2(
      $elm$core$List$take,
      end - start,
  ...
  var $author$project$Donut$Util$toChartData = F3(
    function (numOfVoters, numOfVariations, sortedLst) {
      if (!sortedLst.b) {
        ...
        var determineColor = $author$project$Donut$Util$fromTWcolorToHex(
          x.color,
        );
        return $elm$core$List$isEmpty(xs)
          ...
          : A2($elm$core$List$member, x.groupBy, groupByLst)
            ? _Utils_ap(
                _List_Nil,
                A3(
                  $author$project$Donut$Util$toChartData,
  ...
  var $author$project$Donut$Chart$describeDonutSlice = F6(
    function (cx, cy, innerR, outerR, startAngle, endAngle) {
      ...
      var outerStart = A4(
        $author$project$Donut$Chart$polarToCartesian,
        cx,
        cy,
        outerR,
        endAngle,
      ...
      var largeArcFlag =
        $elm$core$Basics$abs(endAngle - startAngle) <= 180 ? "0" : "1";
      var innerStart = A4(
        $author$project$Donut$Chart$polarToCartesian,
        cx,
        cy,
  ...
  var $elm$svg$Svg$Attributes$strokeWidth =
    _VirtualDom_attribute("stroke-width");
    ...
    function (toSelf, donutOutput, model) {
      ...
      return A2(
        ...
        F2(function (idx, chartData) {
          ...
          var pathD = !chartData.percentage
            ? "M 20 20 L 20 20"
            : A6(
                $author$project$Donut$Chart$describeDonutSlice,
                20,
                20,
                innerRadius,
                outerRadius,
          ...
          return A2(
            ...
            _List_fromArray([
              ...
              $elm$html$Html$Events$onMouseOver(
                toSelf(
                  $author$project$Donut$Chart$SegmentHovered(
                    chartData.uniqueVoteValue,
                  ),
                ),
              ),
          ...
          return A2(
            ...
            _List_fromArray([
              $elm$html$Html$Attributes$class(
                "bg-white shadow-md rounded px-2 py-1 border border-gray-200 text-sm absolute",
              ),
  ...
  var $author$project$Donut$Chart$view = F3(
    function (toSelf, donutInput, model) {
      ...
      return A2(
        ...
        _List_fromArray([
          $elm$html$Html$Attributes$class(
            "flex flex-row items-start gap-4 relative",
          ),
        ]),
        _List_fromArray([
          A2(
            ...
            _List_fromArray([
              A2(
                ...
                A2(
                  ...
                  A3(
                    $author$project$Donut$Chart$segmentsWithEvents,
                    toSelf,
                    donutOutput,
                    model,
                  ),
    ...
    return A2(
      ...
      _List_fromArray([
        A2(
          ...
          _List_fromArray([
            $elm$html$Html$Attributes$class(
              "text-center text-2xl m-2 text-cyan-400",
            ),
          ]),
          _List_fromArray([$elm$html$Html$text("Pie Charts")]),
        ),
        A2(
          $elm$html$Html$ul,
          _List_fromArray([$elm$html$Html$Attributes$class("flex")]),
          A2(
            $elm$core$List$map,
            function (inputs) {
              return A2(
                ...
                _List_fromArray([
                  $elm$html$Html$Attributes$class(
                    "text-red-500 flex w-[500px] h-[500px]",
                  ),
                ]),
                _List_fromArray([
                  A3(
                    $author$project$Donut$Chart$view,
  ...
  var $author$project$Demo$main = $elm$browser$Browser$element({
    init: function (_v0) {
      return _Utils_Tuple2(
        $author$project$Demo$initialModel,
        $elm$core$Platform$Cmd$none,
      );
    },
