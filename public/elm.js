		...
		if (msg.$ === 'SegmentHovered') {
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						hoveredSegment: $elm$core$Maybe$Just(i)
					}),
	...
	function (numOfVoters, numOfVariations, sortedLst) {
		if (!sortedLst.b) {
			...
			return $elm$core$List$isEmpty(xs) ? A2(
				$elm$core$List$cons,
				{color: x.color, id: x.id, numOfVoters: numOfVoters, percentage: (numOfVoters / numOfVariations) * 100, uniqueVoteValue: x.groupBy},
...
var $author$project$Donut$Chart$view = F3(
	function (toSelf, lst, model) {
		var strokeWidth = 3.5;
		var radius = 15.91549430918954;
		var donutOutput = $author$project$Donut$Chart$inputToOutput(lst);
		var segments = A2(
			$elm$core$List$indexedMap,
			F2(
				function (idx, chartData) {
					var randomColor = $author$project$Donut$Util$getHexColor(idx);
					var offset = A2(
						$elm$core$Maybe$withDefault,
						0,
					...
					var isHovered = _Utils_eq(
						...
						$elm$core$Maybe$Just(chartData.uniqueVoteValue));
					var color = function () {
						var _v0 = chartData.color;
						if (_v0.$ === 'Just') {
							var color_ = _v0.a;
							return _Utils_eq(color_, randomColor) ? $author$project$Donut$Util$getHexColor(0) : color_;
						} else {
							return randomColor;
						}
					}();
					return A2(
						...
						_List_fromArray(
							[
								$elm$svg$Svg$Attributes$class('segment-group')
							]),
						_Utils_ap(
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											...
											$elm$core$String$fromFloat(chartData.percentage) + (' ' + $elm$core$String$fromFloat(100 - chartData.percentage))),
											$elm$svg$Svg$Attributes$strokeDashoffset(
											$elm$core$String$fromFloat(100 - offset))
										]),
									_List_Nil)
								]),
							isHovered ? _List_fromArray(
								[
									A2(
									$elm$svg$Svg$text_,
									_List_fromArray(
										[
											...
											$elm$core$String$fromFloat(0)),
											$elm$svg$Svg$Attributes$class('tooltip-label'),
											$elm$svg$Svg$Attributes$textAnchor('middle'),
											$elm$svg$Svg$Attributes$dominantBaseline('middle')
										]),
									_List_fromArray(
										[
											$elm$svg$Svg$text(chartData.uniqueVoteValue)
										]))
								]) : _List_Nil));
				}),
			donutOutput.chartData);
		var baseCircle = _List_fromArray(
			[
				A2(
				$elm$svg$Svg$circle,
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$class('donut-hole'),
						$elm$svg$Svg$Attributes$cx('20'),
						$elm$svg$Svg$Attributes$cy('20'),
						$elm$svg$Svg$Attributes$r(
						$elm$core$String$fromFloat(radius)),
				...
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$class('donut-ring'),
						$elm$svg$Svg$Attributes$cx('20'),
						$elm$svg$Svg$Attributes$cy('20'),
						$elm$svg$Svg$Attributes$r(
						$elm$core$String$fromFloat(radius)),
						...
						$elm$svg$Svg$Attributes$strokeWidth(
						$elm$core$String$fromFloat(strokeWidth)),
						$elm$svg$Svg$Attributes$stroke('#EBEBEB')
					]),
				_List_Nil)
			]);
		return A2(
				...
				[
					...
					_List_fromArray(
						[
							...
							$elm$svg$Svg$Attributes$class('donut')
						]),
					_Utils_ap(baseCircle, segments)),
					A2(
					$elm$html$Html$ul,
					_List_Nil,
					A2(
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text(
												$elm$core$String$fromFloat(chartData.numOfVoters))
											]))
									]));
						},
						donutOutput.chartData))
