...
var $author$project$Donut$Chart$initialModel = {
	hoveredSegment: _Utils_Tuple2($elm$core$Maybe$Nothing, $elm$core$Maybe$Nothing)
};
	...
	function (numOfVoters, numOfVariations, sortedLst) {
		if (!sortedLst.b) {
			...
			return $elm$core$List$isEmpty(xs) ? A2(
				$elm$core$List$cons,
				{color: x.color, id: x.id, percentage: (numOfVoters / numOfVariations) * 100, uniqueVoteValue: x.groupBy},
...
var $author$project$Donut$Chart$inputToOutput = function (dataPointLst) {
	var chartDataLst = A3(
		...
		A2(
			...
			function (dataPoint) {
				var _v1 = A2(
					...
					$elm$core$String$toInt(dataPoint.groupBy));
				if (_v1.$ === 'Just') {
					var _float = _v1.a;
					return _float;
				} else {
...
var $author$project$Donut$Chart$MouseMoved = function (a) {
...
var $author$project$Donut$Util$fromTWcolorToHex = function (twCol) {
	return A2(
		...
		A2(
			...
			function (color) {
				return (color === 'bg-pink-400') ? $elm$core$Maybe$Just('#f472b6') : ((color === 'bg-sky-400') ? $elm$core$Maybe$Just('#38bdf8') : ((color === 'bg-lime-400') ? $elm$core$Maybe$Just('#a3e635') : ((color === 'bg-purple-900') ? $elm$core$Maybe$Just('#581c87') : ((color === 'bg-sky-700') ? $elm$core$Maybe$Just('#0369a1') : ((color === 'bg-lime-500') ? $elm$core$Maybe$Just('#84cc16') : ((color === 'bg-pink-700') ? $elm$core$Maybe$Just('#be185d') : ((color === 'bg-teal-700') ? $elm$core$Maybe$Just('#0f766e') : ((color === 'bg-lime-900') ? $elm$core$Maybe$Just('#365314') : ((color === 'bg-teal-800') ? $elm$core$Maybe$Just('#115e59') : ((color === 'bg-pink-200') ? $elm$core$Maybe$Just('#fbcfe8') : ((color === 'bg-lime-300') ? $elm$core$Maybe$Just('#bef264') : ((color === 'bg-teal-500') ? $elm$core$Maybe$Just('#14b8a6') : ((color === 'bg-sky-600') ? $elm$core$Maybe$Just('#0284c7') : ((color === 'bg-lime-700') ? $elm$core$Maybe$Just('#4d7c0f') : ((color === 'bg-teal-900') ? $elm$core$Maybe$Just('#134e4a') : ((color === 'bg-lime-600') ? $elm$core$Maybe$Just('#65a30d') : ((color === 'bg-pink-300') ? $elm$core$Maybe$Just('#f9a8d4') : $elm$core$Maybe$Nothing)))))))))))))))));
			},
			twCol));
};
		...
		return A2(
			...
			F2(
				function (idx, chartData) {
					...
					var pathD = A6($author$project$Donut$Chart$describeDonutSlice, 20, 20, innerRadius, outerRadius, startAngle, endAngle);
					var color = A2(
						$elm$core$Maybe$withDefault,
							...
							[
								...
								A3(
									...
									F2(
										function (x, y) {
											return toSelf(
												$author$project$Donut$Chart$MouseMoved(
													_Utils_Tuple2(x, y)));
										}),
...
var $author$project$Donut$Chart$viewTooltip = F2(
	function (model, donutOutput) {
		...
		if ((_v0.a.$ === 'Just') && (_v0.b.$ === 'Just')) {
			var segmentId = _v0.a.a;
			var segmentCoord = _v0.b.a;
			var _v1 = A2(
			...
			if (_v1.b && (!_v1.b.b)) {
				...
				return A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('bg-white w-[100px] shadow-md rounded p-4 border border-gray-200 text-sm absolute'),
							A2(
							$elm$html$Html$Attributes$style,
							'top',
							$elm$core$String$fromInt(segmentCoord.y) + 'px'),
							A2(
							$elm$html$Html$Attributes$style,
							'left',
							$elm$core$String$fromInt(segmentCoord.x) + 'px')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('text-gray-700 font-medium')
								]),
							_List_fromArray(
								[
						...
						[
							...
							_List_fromArray(
								[
									...
									$elm$svg$Svg$Attributes$viewBox('0 0 40 40'),
									$elm$svg$Svg$Attributes$class('w-full h-auto ml-2 mt-2'),
									$elm$svg$Svg$Attributes$transform('rotate(-90 20 20)')
								]),
							A2(
								$elm$core$List$cons,
...
var $author$project$Main$view = function (model) {
	var donutInputs = _List_fromArray(
		[$author$project$Main$users, $author$project$Main$users1]);
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"Increment":[],"Decrement":[],"ChartMsg":["Donut.Chart.Msg"]}},"Donut.Chart.Msg":{"args":[],"tags":{"SegmentHovered":["String.String"],"SegmentUnhovered":[],"MouseMoved":["( Basics.Int, Basics.Int )"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});
